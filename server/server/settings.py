...
CELERY_BROKER_URL=REDIS_LOCATION#os.environ.get('CELERY_BROKER_URL', "redis://redis:6379/0")
REDIS_CHANNEL_URL=REDIS_LOCATION#os.environ.get('REDIS_CHANNEL_URL', "redis://redis:6379/1")
